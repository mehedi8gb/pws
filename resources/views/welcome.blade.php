...
<body class="bg-gray-100 h-screen flex justify-center items-center">
    <div class="bg-white shadow-md rounded-lg p-6 w-96 text-center">
        <h1 class="text-2xl font-semibold mb-4">File System</h1>
        <p class="text-gray-600 mb-4">Welcome to the file system. Manage and access your secret files securely.</p>
    </div>
</body>
</html>
