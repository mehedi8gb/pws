...
Route::post('move/temp/to/permanent', [FileController::class, 'moveToPermanent'])->name('file.moveToPermanent');
Route::post('temp/files/upload', [FileController::class, 'tempStore'])->name('file.tempStore');
